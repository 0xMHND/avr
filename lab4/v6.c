...
// cases:
//       set_clock_mode: (priority : 1)
//              encoders increase/decrease minutes&hours of the clock
//       set_alarm_mode: (priority : 2)
//              encoders increase/decrease minutes&hours of the alarm
//       set_volum_mode: (priority : 3)
//              encoders increase/decrease volume of the alarm in 50 steps.
//
