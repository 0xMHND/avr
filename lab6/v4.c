...
#include "music/kellen_music.h"
#include "functions/functions.h"
#include "LCD/LCDDriver.h"
#include "lm73/lm73_functions.h"
...
ISR(TIMER0_OVF_vect){
    ...
    switch(resolution){
        case 0:
            sprintf(second_line, "L>%3.3s O>%3.3s    %c", local_temp, outside_temp, temp_unit?'F':'C'); //copy temp_digits to lcd_outside
            break;
        case 1:
            sprintf(second_line, "L>%5.5s O>%5.5s%c", local_temp, outside_temp, temp_unit?'F':'C'); //copy temp_digits to lcd_outside
            break;
        case 2:
            sprintf(second_line, "L%6.6s O%6.6s%c", local_temp, outside_temp, temp_unit?'F':'C'); //copy temp_digits to lcd_outside
            break;
        default:
            sprintf(second_line, "L>%3.3s O>%3.3s %c", local_temp, outside_temp, temp_unit?'F':'C'); //copy temp_digits to lcd_outside
            break;
