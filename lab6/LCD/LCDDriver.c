...
void LCD_Init(void) {
	...
	*/
	...
	// Create a custom signal highest in slot 1
	//LCD_CMD(0x44); // <-- address of custom slot 4
	LCD_DATA(0x0E); // <-- top 5 pixels of icon
	LCD_DATA(0x1F); // <-- next 5 pixels of icon
	LCD_DATA(0x1F);
	LCD_DATA(0x1F);
	LCD_DATA(0x1F);
	LCD_DATA(0x1F);
	LCD_DATA(0x1F);
	LCD_DATA(0x0E); // <-- bottom 5 pixels of icon
	// Create a custom signal second highest in slot 2
	//LCD_CMD(0x48); // <-- address of custom slot 1
	LCD_DATA(0x00); // <-- top 5 pixels of icon
	LCD_DATA(0x00); // <-- next 5 pixels of icon
	LCD_DATA(0x0E);
	LCD_DATA(0x1F);
	LCD_DATA(0x1F);
	LCD_DATA(0x1F);
	...
	// Create a custom signal third highest in slot 3
	//LCD_CMD(0x42); // <-- address of custom slot 2
	LCD_DATA(0x00); // <-- top 5 pixels of icon
	LCD_DATA(0x00); // <-- next 5 pixels of icon
	LCD_DATA(0x00);
	LCD_DATA(0x00);
	...
	LCD_DATA(0x1F);
	LCD_DATA(0x0E); // <-- bottom 5 pixels of icon
	// Create a custom signal logo in slot 4
	//LCD_CMD(0x45); // <-- address of custom slot 4
	LCD_DATA(0x00);
	LCD_DATA(0x1f); // <-- top 5 pixels of icon
	LCD_DATA(0x0E); // <-- next 5 pixels of icon
	LCD_DATA(0x04);
	LCD_DATA(0x04);
	LCD_DATA(0x04);
	LCD_DATA(0x04);
	LCD_DATA(0x04); // <-- bottom 5 pixels of icon
	// Create a Celsius Sign in slot 5
	//LCD_CMD(0x43); // <-- address of custom slot 3
	LCD_DATA(0x18); // <-- top 5 pixels of icon
	LCD_DATA(0x18); // <-- next 5 pixels of icon
	LCD_DATA(0x00);
	LCD_DATA(0x06);
	LCD_DATA(0x09);
	LCD_DATA(0x08);
	LCD_DATA(0x09);
	LCD_DATA(0x06); // <-- bottom 5 pixels of icon
	// Create a Fahrenheit Sign in slot 6
	//LCD_CMD(0x43); // <-- address of custom slot 3
	LCD_DATA(0x18); // <-- top 5 pixels of icon
	LCD_DATA(0x18); // <-- next 5 pixels of icon
	LCD_DATA(0x00);
